...
import { TextInput, ColorInput } from '@/components/ui/form-inputs';
      ...
      <DataTable
        columns={[
          ...
          { header: 'Color', key: 'color', render: (row) => (
            row.color ? <div className="w-6 h-6 rounded-full" style={{ backgroundColor: row.color }} /> : null
          )},
