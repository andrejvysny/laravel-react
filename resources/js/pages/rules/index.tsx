    ...
    <AppLayout>
      ...
      <div className="mx-auto w-full max-w-7xl p-4">
        <div className="mx-auto w-full max-w-7xl">
          <PageHeader title="Rules" buttons={[
            {
      ...
      <DataTable
        columns={[
          ...
          { header: 'Condition', key: 'condition', render: (row) => (
            <span>
          ...
          { header: 'Status', key: 'status', render: (row) => (
            <span className={`rounded-full px-2 py-1 text-xs ${row.is_active ? 'bg-green-900 text-green-300' : 'bg-gray-700 text-gray-300'}`}>
