...
export default function TransactionDetails({ transaction }: Props) {
    return (
        <div className="rounded-lg bg-background text-base p-4 mt-2">
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    <p className="text-sm text-muted-foreground">Booked Date</p>
                ...
                {transaction.target_iban && (
                    <div>
                        <p className="text-sm text-muted-foreground">Target IBAN</p>
                        <p>{transaction.target_iban}</p>
                    </div>
                )}
                {transaction.source_iban && (
                    <div>
                        <p className="text-sm text-muted-foreground">Source IBAN</p>
            ...
            {transaction.metadata && (
                <div className="mt-4 border-t border-gray-700 pt-4">
                    <h4 className="mb-2 text-sm text-muted-foreground">Additional Information</h4>
            ...
            {transaction.import_data && (
                <div className="mt-4 border-t border-gray-700 pt-4">
                    <h4 className="mb-2 text-sm text-muted-foreground">Original Imported Data</h4>
                    <div className="rounded-lg bg-gray-900 p-3">
